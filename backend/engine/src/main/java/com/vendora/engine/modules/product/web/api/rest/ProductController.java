package com.vendora.engine.modules.product.web.api.rest;
...
import com.vendora.engine.modules.product.web.validator.GetProductsWebRequest;
...
public class ProductController {
  ...
  public ResponseEntity<Product> createProduct(
    @Valid @RequestBody final CreateProductWebRequest payload
  ) {
  ...
  @GetMapping("")
  public ResponseEntity<Page<Product>> getProducts(@Valid final GetProductsWebRequest payload) {
  ...
  public ResponseEntity<Product> updateProduct(
    @Valid @RequestBody final UpdateProductWebRequest payload,
