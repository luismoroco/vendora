...
@NoArgsConstructor
@AllArgsConstructor
public class PasswordRecoveryWebRequest implements RequestAdapter<PasswordRecoveryRequest> {
  @NotBlank(message = "Email cannot be missing or empty")
  @Email(message = "Must be a well-formed email address")
  private String email;

  @Override
  public Class<PasswordRecoveryRequest> getTargetClass() {
    return PasswordRecoveryRequest.class;
  }
}
